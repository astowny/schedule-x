...
import { CalendarConfigExternal } from '@holitime/schedule-x-shared/src/interfaces/calendar/calendar-config'
...
import { translate, translations } from '@holitime/schedule-x-translations/src'
