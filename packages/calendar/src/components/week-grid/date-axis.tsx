import { WeekWithDates } from '@holitime/schedule-x-shared/src/types/time'
import { getDayNameShort } from '@holitime/schedule-x-shared/src/utils/stateless/time/date-time-localization/date-time-localization'
import { useContext } from 'preact/hooks'
import { AppContext } from '../../utils/stateful/app-context'
import { isToday } from '@holitime/schedule-x-shared/src/utils/stateless/time/comparison'
import { getClassNameForWeekday } from '../../utils/stateless/get-class-name-for-weekday'
import { toDateString } from '@holitime/schedule-x-shared/src'
