import DragAndDropPlugin from '@holitime/schedule-x-shared/src/interfaces/drag-and-drop/drag-and-drop-plugin.interface'
...
import MonthGridDragHandler from '@holitime/schedule-x-shared/src/interfaces/drag-and-drop/month-grid-drag-handler.interface'
...
import TimeGridDragHandler from '@holitime/schedule-x-shared/src/interfaces/drag-and-drop/time-grid-drag-handler.interface'
import DragHandlerDependencies from '@holitime/schedule-x-shared/src/interfaces/drag-and-drop/drag-handler-dependencies.interface'
